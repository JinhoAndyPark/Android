	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btnPanorama.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				btnPanorama.setVisibility(View.GONE);
				btnStabilize.setVisibility(View.GONE);
				btnPanoramaSelect.setVisibility(View.VISIBLE);
		...
		public void handleMessage(Message msg) {
			...
			case DataConstants.MESSAGE_READ:
				...
				if(readMessage.matches("///.*///.*")){
					Log.d("MCU 통신", "센서값 받았다!");
					Log.d("MCU 통신", "readMessage = " + readMessage);				

					String[] result = readMessage.split("///");	
					String sendString = "8";
					Log.d("MCU 통신", "result[0] = " + result[0]);
					Log.d("MCU 통신", "result[1] = " + result[1]);
					Log.d("MCU 통신", "result[2] = " + result[2]);
